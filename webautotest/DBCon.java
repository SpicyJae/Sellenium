...
public class DBCon {
	...
	/*
	 * Role Type = '2' : Client admin 
	 * Role Type = '3' : Observer
	 * 
	 * But i select account which language is english
	 */
	public String GetAvailAccount(int role_type) throws SQLException {
		String sql = "SELECT * FROM( SELECT * FROM user_info where role_type='"+role_type+"' and password='912ec803b2ce49e4a541068d495ab570' and ACCT_ID IN (SELECT ACCT_ID FROM ACCOUNT WHERE LANGUAGE='1') ORDER BY dbms_random.value ) WHERE rownum = 1";
